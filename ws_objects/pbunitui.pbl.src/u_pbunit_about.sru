$PBExportHeader$u_pbunit_about.sru
forward
...
string text = "Ported to PowerBuilder from Kent Beck and Eric Gamma~'s JUnit 2.1 Unit testing framework by John Urberg and Jaimme York, upgraded GUI interface by Phil Yandel, Frank Mao,                    further development by Aleksander Skjæveland Larsen"
alignment alignment = center!
